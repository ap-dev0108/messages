...
public class ConversationController {
    ...
    public ResponseEntity<Response<List<ConversationResponseDTO>>> getConversation(Authentication authentication) {
        List<ConversationResponseDTO> conversation = conversationService.getConversation(authentication);
